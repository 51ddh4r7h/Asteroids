...
import numpy as np
from prediction_model.processing.preprocessing import CorrelationFeatureSelector
...
classification_pipeline = Pipeline(
    [
        ...
        ('CorrelationFeatureSelector', pp.CorrelationFeatureSelector(threshold=0.9)),  # Add 
